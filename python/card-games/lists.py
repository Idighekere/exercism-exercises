...
def approx_average_is_average(hand):
    ...
    return average in ( middle_value, approx_average)
...
def average_even_is_average_odd(hand):
    ...
    even_list = [hand[i] for i in range(0,len(hand),2)]
    odd_list = [hand[i] for i in range(1,len(hand),2)]
